...
@section('header', 'Tambah Pengarang Baru')
...
@section('content')
    <form action="{{ route('pengarang.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="kode_pengarang" name="kode_pengarang" value="{{ old('kode_pengarang') }}" class="mt-1 block w-full border p-2 rounded" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="nama_pengarang" name="nama_pengarang" value="{{ old('nama_pengarang') }}" class="mt-1 block w-full border p-2 rounded" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="gelar_depan" name="gelar_depan" value="{{ old('gelar_depan') }}" class="mt-1 block w-full border p-2 rounded">
        </div>

        <div class="mb-4">
            <label for="gelar_belakang" class="block text-gray-700">Gelar Belakang</label>
            <input type="text" id="gelar_belakang" name="gelar_belakang" value="{{ old('gelar_belakang') }}" class="mt-1 block w-full border p-2 rounded">
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea id="biografi" name="biografi" rows="4" class="mt-1 block w-full border p-2 rounded">{{ old('biografi') }}</textarea>
        </div>

        <div class="mb-4">
            <label for="keterangan" class="block text-gray-700">Keterangan</label>
            <input type="text" id="keterangan" name="keterangan" value="{{ old('keterangan') }}" class="mt-1 block w-full border p-2 rounded">
        </div>
